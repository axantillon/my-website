<template>
    <div class="my-4">
        ...
        <div class="text-center">
            ...
            <svg v-if='loading' class="mx-auto my-4 animate-spin-slow" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
        ...
        <input v-model="question" type="text" placeholder="Where did you grow up?"  @focus="delayed_Q()" @blur="askQ()"
        class="bg-gray-100 block mx-auto w-3/4 px-4 py-2 text-center text-xl font-light shadow-md rounded-2xl 
